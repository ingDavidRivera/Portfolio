          ...
          <div className="p-4 lg:w-1/2 md:w-full">
            <div className="flex border-2 rounded-lg border-gray-200 border-opacity-50 p-8 sm:flex-row flex-col">
              ...
              <div className="flex-grow">
                <h2 className="text-gray-900 text-lg title-font font-medium mb-3">ToDo List miniproject</h2>
                <p className="leading-relaxed text-base">In this project we created a ToDo List miniproject related to bootcamp tasks.</p>
